...
@section('content')
    <div class="container mx-auto px-4 sm:px-8">
        <div class="py-8">
            <div>
                <h2 class="text-2xl font-semibold leading-tight">Liste des Elements Constitutifs</h2>
                <div class=" my-6"><a href="{{ route('elements-constitutifs.create') }}"
                                ...
                                <tr>
                                    ...
                                    <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                                        <div class="flex items-center justify-end space-x-4">
                                            ...
                                            <!-- Bouton Supprimer -->
                                            <form action="{{ route('elements-constitutifs.destroy', $ec->id) }}" method="POST" class="inline-block">
                                                @csrf
                                                @method('DELETE')
